...
//
//  Created by Erk Ekin on 11/01/14.
//  Copyright (c) 2014 modilişim. All rights reserved except as below:
...
+(UIImageView*)iOS7IconMaskedImageViewWithImage:(UIImage*)image iconSize:(int)size{
    
    float iconSize = size;
    CGRect rect = CGRectMake(0, 0, iconSize, iconSize);
    CAShapeLayer *maskLayer = [CAShapeLayer layer];
    UIBezierPath *roundedPath = [UIBezierPath bezierPathWithIOS7RoundedRect:rect cornerRadius:35];
    ...
    imageView.frame = CGRectMake(0, 0, iconSize, iconSize);
